export const quotes = [
  ...
  {
    text: 'The best software is that which is easy to use and simple to understand.',
    author: 'Grady Booch',
  },
  {
  ...
  {
    text: 'You can’t have great software without a great team, and most software teams behave like families in need of therapy.',
    author: 'Jim McCarthy',
  },
  {
  ...
  {
    text: 'In software, the key is to define the problem. Once the problem is defined, it can be solved.',
  ...
  {
    text: 'Software, in some sense, is just words that we use to communicate with the computer.',
    author: 'Shinya Yuki',
  },
  {
  ...
  {
    text: "Code refactoring is like doing the dishes. It's never really done.",
    author: 'Jeff Atwood',
  },
  {
  ...
  {
    text: 'The computer does exactly what you tell it to do, not what you want it to do.',
    author: 'Jeff Atwood',
  },
  {
  ...
  {
    text: 'In software, the whole is indeed greater than the sum of its parts.',
    author: "Gosper's Law",
  },
  {
  ...
  {
    text: 'You think you know when you learn, are more sure when you can write, even more when you can teach, but certain when you can program.',
    author: 'Alan Perlis',
  },
  {
