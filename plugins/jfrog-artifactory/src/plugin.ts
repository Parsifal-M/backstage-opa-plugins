...
import { JfrogArtifactoryApiClient, jfrogArtifactoryApiRef } from './api/artifactoryApiClient';
import { JFROG_ARTIFACTORY_ANNOTATION_ARTIFACT_NAME } from './components/useJfrogArtifactoryAppData';
...
export const isJfrogArtifactoryAvailable = (entity: Entity) =>
  Boolean(
    entity?.metadata.annotations?.[JFROG_ARTIFACTORY_ANNOTATION_ARTIFACT_NAME],
  );
