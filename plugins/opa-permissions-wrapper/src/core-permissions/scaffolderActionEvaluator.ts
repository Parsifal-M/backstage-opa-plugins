...
export const scaffolderActionPolicyEvaluator = (
  opaClient: OpaClient,
  config: Config,
) => {
  return async (
    ...
    const opaScaffolderActionPackage = config.getString(
      'opaClient.policies.scaffolderActionPermission.package',
    );
